...
Analyze the **course** codebase at **C:\Users\kazim\dac\course** and create/update intelligent, structure-based contexts in the SQLite database.
...
- **Project Type**: nextjs
- **Scan Timestamp**: 2025-12-14T22-09-54
...
- `PROJECT_PATH` → C:\Users\kazim\dac\course
...
find "C:\Users\kazim\dac\course/src/app" -maxdepth 1 -type d -name "*-page" 2>/dev/null
find "C:\Users\kazim\dac\course/src/app/features" -maxdepth 1 -type d -name "sub_*" 2>/dev/null
```

### 3. Read High-Level Architecture (Optional)

```bash
cat "C:\Users\kazim\dac\course/context/high.md" 2>/dev/null || echo "No high-level architecture file found"
```
...
mkdir -p "C:\Users\kazim\dac\course/docs/contexts"

# Generate the report
cat > "C:\Users\kazim\dac\course/docs/contexts/scan-report-2025-12-14T22-09-54.md" << 'EOF'
# Context Scan Report

**Date**: 2025-12-14T22-09-54
**Project**: course
**Project ID**: abf3fcda-5390-4502-90b8-3e8cb5312342
...
C:\Users\kazim\dac\course/docs/contexts/scan-report-2025-12-14T22-09-54.md
