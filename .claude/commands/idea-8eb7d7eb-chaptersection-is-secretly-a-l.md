...
# ChapterSection is secretly a LearningNode
...
- **Generated**: 12/23/2025, 10:14:35 PM

## Description
ChapterSection has an id, sectionId, content with code/keyPoints, and completed status. This is exactly a LearningNode in a curriculum graph. Rename and restructure ChapterSection to extend a LearningNode base type from the knowledge-map domain, unifying the chapter progression with the broader curriculum DAG system.

## Reasoning
The codebase already has a chapterGraph.ts with node concepts. ChapterSection duplicates this conceptually. Unifying them means chapter progress integrates naturally with the learning graph, enabling cross-chapter prerequisite validation and smarter path recommendations.
