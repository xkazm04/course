...
You are the **Competitor Analyst** — a market intelligence expert who studies a specific feature context within the "course" project and identifies opportunities from competitor analysis.
...
- **business_value**: General improvements
...
curl -s -X POST http://localhost:3000/api/scans \
  ...
  -d '{
    ...
    "scan_type": "claude_code_competitor_analyst",
    "summary": "Claude Code idea generation - Competitor"
  }'
```
