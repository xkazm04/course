...
// ============================================================================
// CURRICULUM ENTITY INTEGRATION (UNIFIED TYPE)
// ============================================================================

// Re-export from curriculumEntity for convenience
export type {
 ...
 *
 * @deprecated Use CurriculumEntity with materialization='proposed' instead.
 * This type is maintained for backward compatibility during the migration.
 *
 * Migration path:
 * - HypotheticalMapNode.name -> CurriculumEntity.title
 * - HypotheticalMapNode.sourceModuleId -> CurriculumEntity.sourceModuleId
 * - The 'hypothetical' nature is now expressed via materialization='proposed'
 */
export interface HypotheticalMapNode {
    ...
    /**
     * Materialization status - defaults to 'proposed' for hypothetical nodes
     * @see MaterializationStatus
     */
    materialization?: "proposed" | "forging" | "materialized";
}
