...
import type { CurriculumNode } from "../../lib/curriculumTypes";

export interface FocusModeBannerProps {
...
/**
 * Banner displayed when focus mode is active.
 */
            ...
            <div className="flex items-center gap-3">
                ...
                <div>
                    ...
                    <p className="text-xs text-indigo-600/70 dark:text-indigo-400/70">
                        {selectedNode
                            ? `Showing path for "${selectedNode.title}" - ${focusedNodeCount} connected nodes`
