...
const STATUS_COLORS = {
    ...
    available: "text-[var(--forge-text-muted)]",
    locked: "text-[var(--forge-text-muted)] opacity-50",
};
...
export const ConnectionsPanel: React.FC<ConnectionsPanelProps> = ({
    ...
    return (
        <motion.div
            ...
            exit={{ opacity: 0, y: -10 }}
            className={cn(
                "bg-[var(--forge-bg-elevated)]/95 backdrop-blur-sm",
        ...
        >
            ...
            <div className="px-4 py-3 border-b border-[var(--forge-border-subtle)]">
                <div className="flex items-center gap-2">
                    <Compass className="w-4 h-4 text-[var(--ember)]" />
                    <span className="text-sm font-semibold text-[var(--forge-text-primary)]">
                        Navigation
                    </span>
                    {keyboardActive && (
                        <span className="flex items-center gap-1 px-1.5 py-0.5 rounded text-xs bg-[var(--ember)]/20 text-[var(--ember)]">
            ...
            {!hasConnections ? (
                <div className="px-4 py-6 text-center">
                    <Navigation className="w-8 h-8 mx-auto text-[var(--forge-text-muted)] mb-2" />
                ...
                <div className="divide-y divide-[var(--forge-border-subtle)]">
                    ...
                    {suggestedNext && (
                        <div className="px-4 py-3">
                            <div className="flex items-center gap-1.5 text-xs text-[var(--forge-warning)] font-medium mb-2">
                    ...
                    {forwardTargets.length > 0 && (
                        <div className="px-4 py-3">
                            <div className="flex items-center gap-1.5 text-xs text-[var(--forge-text-muted)] font-medium mb-2">
            ...
            <div className="px-4 py-2 bg-[var(--forge-bg-workshop)] border-t border-[var(--forge-border-subtle)]">
                <p className="text-xs text-[var(--forge-text-muted)] text-center">
                    Use <kbd className="px-1 py-0.5 bg-[var(--forge-bg-elevated)] rounded border border-[var(--forge-border-subtle)] text-[10px]">Tab</kbd> to navigate • <kbd className="px-1 py-0.5 bg-[var(--forge-bg-elevated)] rounded border border-[var(--forge-border-subtle)] text-[10px]">Enter</kbd> to select • <kbd className="px-1 py-0.5 bg-[var(--forge-bg-elevated)] rounded border border-[var(--forge-border-subtle)] text-[10px]">?</kbd> for help
                </p>
            </div>
        </motion.div>
    );
    ...
    return (
        <motion.button
            ...
            className={cn(
                ...
                isFocused && "bg-[var(--ember)]/10 ring-2 ring-[var(--ember)]/50",
                highlighted && !isFocused && "bg-[var(--forge-warning)]/10",
        ...
        >
            ...
            <div className="flex-1 min-w-0">
                <div className="flex items-center gap-1.5">
                    ...
                    {highlighted && (
                        <Sparkles className="w-3 h-3 text-[var(--forge-warning)] flex-shrink-0" />
                    )}
                </div>
                <div className="flex items-center gap-2 text-xs text-[var(--forge-text-muted)]">
                    <span
                        className={cn(
                            ...
                            connection.type === "required" && "bg-[var(--ember)]/20 text-[var(--ember)]",
                            connection.type === "recommended" && "bg-[var(--forge-success)]/20 text-[var(--forge-success)]",
                            connection.type === "optional" && "bg-[var(--forge-bg-workshop)] text-[var(--forge-text-muted)]"
                        )}
                    >
                        {connectionTypeLabel}
                    </span>
