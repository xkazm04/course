            ...
            >
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1 min-w-0">
                  <h4 className={`font-semibold ${isSelected ? 'text-[var(--ember)]' : 'text-[var(--forge-text-primary)]'}`}>
                    {option.label}
                  </h4>
              ...
              {isSelected && (
                ...
                >
                  <svg className="w-3 h-3 text-[var(--oracle-text-on-ember)]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
